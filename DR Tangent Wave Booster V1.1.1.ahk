...
;Added the Set Davinci Resolve Initial State - It sets the workspace to default and goes to EDIT Page to start the software/work
;Added functions to change pages fast on controller (by clickin on MODES names keys)
...
global TIMELINE_TIMEBAR_POS := {"var": "TIMELINE_TIMEBAR_POS", "name": "Timeline Timebar on Edit Tab", "posX": 2050, "posY": 1285}
...
For index, object in _positionsArray {
    ...
    }Else if (index == 60 or index == 90 or index == 120 or index == 150 or index == 180){
        _counterButtonY := _startPositionButtonsY
        _counterButtonX := _counterButtonX + 160
    }
}
