...
;Correction of smaller bugs
;Added Reset Curves VS
;Added Reset Power Windows
;Added Show/Hide Power Windows (alt+h)
;Added channels reset on curves
;The initial position of Timeline and Timebar was changed
;Swaped output and input buttons on Curves VS
;Now when you control nodes going from one to another, if your not on the nodes panel, it clicks there in a "neutral place" so you can delete and have another controls of the nodes - TODO (intercept the shortcut and send it again after made the test)
...
global TIMELINE_WINDOW_POS := {"var": "TIMELINE_WINDOW_POS", "name": "Position of the Timeline on Edit Tab", "posX": 2500, "posY": 1500}
...
Gui Show, w1130 h1020, DR Tangent Wave Booster Ver. 1.1.3
return
GuiEscape:
GuiClose:
    ExitApp
