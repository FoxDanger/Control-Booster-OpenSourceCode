;Shortcuts list used for the Davinci Resolve Tangent Wave Booster
;Version 1.1.2
;ANY NON LISTED SHORTCUT IS ALREADY IN USE FOR THE SOFTWARE OR WINDOWS (TODO - Finish the list with all the shortcuts with description of each)

;Keys
Insert::
Del:: ;DAVINCI RESERVED - DELETE
Home:: ;DAVINCI RESERVED - HOME
End:: ;DAVINCI RESERVED - END
PgUp::
PgDn::
F1:: ;F1 - Exit any control
F2:: ;F2 - DEFAULT SHORTCUT TO MAKE TESTS
F3::
F4::
F5:: ;F5 - DAVINCI SHORTCUT EDITED - Set UI to Full Screen
F6:: ;F6 - DAVINCI SHORTCUT EDITED - Reset Layout UI
F7:: ;F7 - Set Davinci to Initial State (Reset UI, set UI to Full Screen and go to the Edit Page)
F8:: ;F8 - Start/Stop the APP
F9:: ;DAVINCI RESERVED - CLIP INSERT
F10:: ;DAVINCI RESERVED - CLIP OVERWRITE
F11:: ;DAVINCI RESERVED - CLIP REPLACE
F12:: ;DAVINCI RESERVED - CLIPE PLACE ON TOP
Numpad0:: ;Numpad0 - Select Next Curves Panel 
Numpad1:: ;Numpad1 - Select Previous Curves Panel
Numpad2:: ;Numpad2 - Increase Y Channel
Numpad3:: ;Numpad3 - Reduce Y Channel
Numpad4:: ;Numpad4 - Increase R Channel
Numpad5:: ;Numpad5 - Reduce R Channel
Numpad6:: ;Numpad6 - Increase G Channel
Numpad7:: ;Numpad7 - Reduce G Channel
Numpad8:: ;Numpad8 - Increase B Channel
Numpad9:: ;Numpad9 - Reduce B Channel
NumpadDot:: ;DONT WORK
NumpadDiv::
NumpadMult:: ;DONT WORK
NumpadAdd::
NumpadSub::
NumpadEnter:: ;DONT WORK
...
^NumpadDel:: ;DAVINCI RESERVED
^NumpadDiv:: ;DAVINCI RESERVED
^NumpadMult:: ;Ctrl+NumpadDel - Reset Hue
^NumpadAdd:: ;DAVINCI RESERVED
^NumpadSub:: ;DAVINCI RESERVED
^NumpadEnter:: ;Ctrl+NumpadMult - Reset Lum Mix
...
+1:: ;DAVINCI RESERVED - OPEN HOME PROJECTS WINDOW
+2:: ;DAVINCI RESERVED - OPEN MEDIA WORKAREA
+3:: ;DAVINCI RESERVED - OPEN CUT WORKAREA
+4:: ;DAVINCI RESERVED - OPEN EDIT WORKAREA
+5:: ;DAVINCI RESERVED - OPEN FUSION WORKAREA
+6:: ;DAVINCI RESERVED - OPEN COLOR WORKAREA
+7:: ;DAVINCI RESERVED - OPEN FAIRLIGHT WORKAREA
+8:: ;DAVINCI RESERVED - OPEN DELIVERY WORKAREA
+9:: ;DAVINCI RESERVED - OPEN PROJECT SETTINGS
+0::
+-::
+=::
+Numpad0:: ;DONT WORK (same as insert)
+Numpad1:: ;SAME THAN PRESS THE CLEAN KEY (End, Home and Arrow Keys)
+Numpad2:: ;SAME THAN PRESS THE CLEAN KEY (End, Home and Arrow Keys)
+Numpad3::
+Numpad4:: ;SAME THAN PRESS THE CLEAN KEY (End, Home and Arrow Keys)
+Numpad5::
+Numpad6:: ;SAME THAN PRESS THE CLEAN KEY (End, Home and Arrow Keys)
+Numpad7:: ;SAME THAN PRESS THE CLEAN KEY (End, Home and Arrow Keys)
+Numpad8:: ;SAME THAN PRESS THE CLEAN KEY (End, Home and Arrow Keys)
+Numpad9::
+NumpadDot:: 
+NumpadDiv:: ;DAVINCI RESERVED
...
!b:: ;Alt+b - DAVINCI RESERVED - ADD NODE + CURVE MASK
!c:: ;Alt+c - DAVINCI RESERVED - ADD NODE + CIRCLE MASK
!g:: ;Alt+g - DAVINCI RESERVED - ADD NODE + POLYGON MASK
!j:: ;Alt+j - WB Selector
!n:: ;Alt+n - Pick Black Point
!q:: ;Alt+q - DAVINCI RESERVED - ADD NODE + LINEAR MASK
!0:: ;Alt+0 - Pick White Point
!-::
!=::
!Numpad0::
!Numpad1:: ;Same than press the numbers
!Numpad2:: ;Same than press the numbers
!Numpad3:: ;Same than press the numbers
!Numpad4:: ;Same than press the numbers
!Numpad5:: ;Same than press the numbers
!Numpad6:: ;Same than press the numbers
!Numpad7:: ;Same than press the numbers
!Numpad8:: ;Same than press the numbers
!Numpad9:: ;Same than press the numbers
!NumpadDot::
!NumpadDiv:: ;DAVINCI RESERVED
!NumpadMult::
!NumpadAdd:: ;DAVINCI RESERVED
...
^#c:: ;Ctrl+Win+c - Select Green Channel to Soft Clip
^#d:: ;WINDOWS RESERVED
...
^#Insert::
^#Delete::
^#Home:: ;WINDOWS RESERVED
^#End:: ;WINDOWS RESERVED
^#PgUp:: ;WINDOWS RESERVED
^#PgDn:: ;WINDOWS RESERVED
^#NumpadDot::
^#NumpadDiv::
^#NumpadMult::
^#NumpadAdd::
...
!#+c:: ;Shift+Alt+Win+c - Red Output - Green Bar - IncreaseW
...
!#+F4:: ;WINDOWS RESERVED (can close the software)
