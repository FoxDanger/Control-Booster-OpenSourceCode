...
Gui Add, Tab3, x8 y176 w1905 h900 Choose1, Edit Page Interface|Inspector Transform|Color Page Interface|Wheels/Jogs|Primaries YRGB|Primaries Tools|Log Wheels|Log Tools|HDR Controllers|HDR Tools|HDR Zone|RGB Mixer|Curves Dots/Options|Custom Curves|Hue Curves|Qualifier|Qualifier Matte Finess|Power Windows|BSM|Key|Motion Effects|Scopes|Other
...
Osc2ahkAddOrRemoveListeners(addOrRemove := "add"){
    if (addOrRemove == "add"){
        ...
        DllCall("OSC2AHK.dll\addListener", AStr, "/hdrZoneFalloffReset", UInt, 0x1493, UInt, oscTypeInt)
        OnMessage(0x1493, "_hdrZoneFalloffReset") ;Latest Low
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/hdrZoneMinMaxRangeReset", UInt, 0x1492, UInt, oscTypeInt)
        OnMessage(0x1492, "_hdrZoneMinMaxRangeReset")
        ...
        ;Extra fix problems functions
        DllCall("OSC2AHK.dll\removeListener", AStr, "/hdrZoneFalloffReset", UInt, 0x1493, UInt, oscTypeInt)
        OnMessage(0x1493, "_hdrZoneFalloffReset")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/hdrZoneMinMaxRangeReset", UInt, 0x1492, UInt, oscTypeInt)
        OnMessage(0x1492, "_hdrZoneMinMaxRangeReset")
...
;Button - Reset Falloff on HDR Zone Panel
_hdrZoneFalloffReset(oscType, data, msgID, hwnd){
...
;Button - Reset Min/Max Range on HDR Zone Panel
_hdrZoneMinMaxRangeReset(oscType, data, msgID, hwnd){
    if (CheckIfColorPanelData0(data, "HDR", true) == False)
    Return
