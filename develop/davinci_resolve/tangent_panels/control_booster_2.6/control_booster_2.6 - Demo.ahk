;Control Booster for Tangent Panels - Demo Version
;Version: 2.6 - Demo
...
;Gui Show, % "w" . A_ScreenWidth-100 . " h" . A_ScreenHeight-100, Control Booster for Tangent Panels - 2.6 - Demo
Gui Show, % "w" . 1920 . " h" . 1080, Control Booster for Tangent Panels - 2.6 - Demo
...
WinMinimize Control Booster for Tangent Panels - 2.6 - Demo
...
StartOSC2AHK(){
    ...
    if (success != 0){
        ...
        msgbox, Control Booster for Tangent Panels - Demo is ready to be used!
    }
...
;Big change on verson 2.6 - Now if you're using some tool, will not release to get other tool. You need wait the auto release to use another tool
