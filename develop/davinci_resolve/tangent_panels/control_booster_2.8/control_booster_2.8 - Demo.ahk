...
#Maxmem 512 ;Set the max use of memory by the software
...
;Set if user is using 2 or more monitors. Can be: 0 - False or 1 - True
Global _dualView := 0
...
Gui Add, ComboBox, g_change_curves_hash vcomboboxCurvesHashs x360 y148 w100, 1|2|3|4
...
Gui Add, CheckBox, g_set_dual_view_state vdualViewState x790 y150 w403 h23, Check this box if your using 2 monitors with Dual View mode
...
Gui Tab, 2
Gui Add, Picture, x200 y332 w570 h400,  %A_ScriptDir%\images\Inspector Transform Panel.png
Gui Add, Button, g_set_variable_button vpos_inspector_video x200 y268 w150 h50, Video
Gui Add, Button, g_set_variable_button vpos_inspector_transform_on_off x40 y332 w150 h50, Transform On/Off
Gui Add, Button, g_set_variable_button vpos_inspector_horizontal_flip x40 y612 w150 h50, Horizontal Flip
Gui Add, Button, g_set_variable_button vpos_inspector_vertical_flip x40 y684 w150 h50, Vertical Flip
Gui Add, Button, g_set_variable_button vpos_inspector_zoom_x x208 y748 w150 h50, Zoom X
Gui Add, Button, g_set_variable_button vpos_inspector_zoom_y x368 y748 w150 h50, Zoom Y
Gui Add, Button, g_set_variable_button vpos_inspector_position_x x208 y812 w150 h50, Position X
Gui Add, Button, g_set_variable_button vpos_inspector_position_y x368 y812 w150 h50, Position Y
Gui Add, Button, g_set_variable_button vpos_inspector_rotation_angle x208 y876 w150 h50, Rotation Anglers 
Gui Add, Button, g_set_variable_button vpos_inspector_anchor_point_x x536 y748 w150 h50, Anchor Point X
Gui Add, Button, g_set_variable_button vpos_inspector_anchor_point_y x696 y748 w150 h50, Anchor Point Y
Gui Add, Button, g_set_variable_button vpos_inspector_pitch x536 y812 w150 h50, Pitch
Gui Add, Button, g_set_variable_button vpos_inspector_yaw x696 y812 w150 h50, Yaw
Gui Add, Button, g_set_variable_button vpos_inspector_zoom_link x464 y268 w150 h50, Transform Zoom Link
Gui Add, Button, g_set_variable_button vpos_inspector_transform_reset x624 y268 w150 h50, Transform Reset
Gui Add, Button, g_set_variable_button vpos_inspector_zoom_reset x784 y300 w150 h50, Zoom Reset
Gui Add, Button, g_set_variable_button vpos_inspector_position_reset x784 y364 w150 h50, Position Reset
Gui Add, Button, g_set_variable_button vpos_inspector_rotation_angle_reset x784 y428 w150 h50, Rotation Angle Reset
Gui Add, Button, g_set_variable_button vpos_inspector_anchor_point_reset x784 y492 w150 h50, Anchor Point Reset
Gui Add, Button, g_set_variable_button vpos_inspector_pitch_reset x784 y556 w150 h50, Pitch Reset
Gui Add, Button, g_set_variable_button vpos_inspector_yaw_reset x784 y620 w150 h50, Yaw Reset
Gui Add, Button, g_set_variable_button vpos_inspector_flip_reset x784 y684 w150 h50, Flip Reset
Gui Add, Button, g_set_variable_button vpos_inspector_transform_keyframe x368 y876 w150 h50, Transform Keyframe
Gui Add, Button, g_set_variable_button vpos_inspector_zoom_keyframe x536 y876 w150 h50, Zoom Keyframe
Gui Add, Button, g_set_variable_button vpos_inspector_anchor_keyframe x368 y940 w150 h50, Anchor Point Keyframe
Gui Add, Button, g_set_variable_button vpos_inspector_position_keyframe x696 y876 w150 h50, Position Keyframe
Gui Add, Button, g_set_variable_button vpos_inspector_pitch_keyframe x536 y940 w150 h50, Pitch Keyframe
Gui Add, Button, g_set_variable_button vpos_inspector_rotation_keyframe x208 y940 w150 h50, Rotation Angle Keyframe
Gui Add, Button, g_set_variable_button vpos_inspector_yaw_keyframe x696 y940 w150 h50, Yaw Keyframe
Gui Add, Picture, x1152 y332 w570 h380,  %A_ScriptDir%\images\Inspector Audio Panel.png
Gui Add, Button, g_set_variable_button vpos_inspector_audio x1152 y268 w150 h50, Audio
Gui Add, Button, g_set_variable_button vpos_inspector_audio_reset x1736 y340 w150 h50, Audio Reset
Gui Add, Button, g_set_variable_button vpos_inspector_audio_volume_on_off x992 y404 w150 h50, Volume On/Off
Gui Add, Button, g_set_variable_button vpos_inspector_audio_volume x1152 y724 w150 h50, Volume
Gui Add, Button, g_set_variable_button vpos_inspector_audio_volume_reset x1736 y404 w150 h50, Volume Reset
Gui Add, Button, g_set_variable_button vpos_inspector_audio_volume_keyframe x1152 y788 w150 h50, Volume keyframe
Gui Add, Button, g_set_variable_button vpos_inspector_audio_pan_on_off x992 y500 w150 h50, Pan On/Off
Gui Add, Button, g_set_variable_button vpos_inspector_audio_pan x1312 y724 w150 h50, Pan
Gui Add, Button, g_set_variable_button vpos_inspector_audio_pan_reset x1736 y468 w150 h50, Pan Reset
Gui Add, Button, g_set_variable_button vpos_inspector_audio_pan_keyframe x1312 y788 w150 h50, Pan Keyframe
Gui Add, Button, g_set_variable_button vpos_inspector_audio_pitch_on_off x992 y588 w150 h50, Pitch On/Off
Gui Add, Button, g_set_variable_button vpos_inspector_audio_pitch_semi_tones x1472 y724 w150 h50, Semi Tones
Gui Add, Button, g_set_variable_button vpos_inspector_audio_pitch_semi_tones_reset x1736 y596 w150 h50, Semi Tones Reset
Gui Add, Button, g_set_variable_button vpos_inspector_audio_pitch_cents x1472 y788 w150 h50, Cents
Gui Add, Button, g_set_variable_button vpos_inspector_audio_pitch_cents_reset x1736 y660 w150 h50, Cents Reset
Gui Add, Button, g_set_variable_button vpos_inspector_audio_pitch_reset x1736 y532 w150 h50, Pitch Reset
...
;Gui Show, % "w" . A_ScreenWidth-100 . " h" . A_ScreenHeight-100, Control Booster for Tangent Panels - 2.8
Gui Show, % "w" . 1920 . " h" . 1080, Control Booster for Tangent Panels - 2.8

if (_dualView == 1){
    GuiControl,, dualViewState, 1
}
...
WinMinimize Control Booster for Tangent Panels - 2.8
WinMinimize Tangent Mapper

; \/ APP START \/

;Compare two dates to close demo version in case of less than 5 minutes
CheckDemoDate()

;Set the time that the software was started to be checked in the next instance start    
DemoStart()
...
LoadPositions(){
    ...
    Loop, read, %A_ScriptDir%\res_dpi_scale.ini
    {
        Loop, parse, A_LoopReadLine, %A_Tab%
        {
            ...
            loopFieldResolution := SubStr(A_LoopField, 1, startingPos - 2)
            
            if (loopFieldResolution != _resolutionAndScale){
                continue
            }
            ...
            if (InStr(A_Loopfield, "WINDOW") != 0){
                ...
                switch (counter){
                    Case 1:
                        ...
                        if InStr(A_LoopField, "dual_view"){
                            setDualView := True
                        }
                    ...
                    Case 2:
                        ...
                        if (setDualView){
                            _dualView := SubStr(A_Loopfield, startingPos + 1)
...
LoadFindTextHashs(){
    ...
    Loop, read, %A_ScriptDir%\custom_curves_hashs.ini
    {
        Loop, parse, A_LoopReadLine, %A_Tab%
        {
            ...
            if (InStr(A_Loopfield, "dotsHashArray4") != 0){
                switch (counter){
                    Case 1:
                        object := []
                        _dotsHashsArray4.Push(object)
                        
                        startingPos := InStr(A_Loopfield, "=")
                        
                        _dotsHashsArray4[arrayPos].var := SubStr(A_Loopfield, startingPos + 1)
                    ...
                    Case 2:
                        ...
                        _dotsHashsArray4[arrayPos].text := SubStr(A_Loopfield, startingPos + 1)
...
MoveMouseAndClick(object, bringMouseToOriginalPos := False){
    object := GetObjectOnPositionsArray(object)
    
    if (bringMouseToOriginalPos){
...
;Big change on verson 2.8 - Now if you're using some tool, will not release to get other tool. You need wait the auto release to use another tool
MoveMouseAndDrag(data, axis, objectName := "NULL", isDot := False, speedMultiplier := 0){
    if (_activeController == "OFF"){
    ...
    }Else if(_activeController != objectName){
        Return        
    }
...
_sizingOutputBlankingLeft(oscType, data, msgID, hwnd){
    if (data == 0){
        ResetForSpecificValue("pos_sizing_output_blanking_left", 2160)
        Return
    }Else {
...
_sizingOutputBlankingRight(oscType, data, msgID, hwnd){
    if (data == 0){
        ResetForSpecificValue("pos_sizing_output_blanking_right", 3840)
        Return
    }Else {
...
_trackingStepFramesTrack(oscType, data, msgID, hwnd){
    if (data < 0){
        MoveMouseAndClick("pos_tracking_one_frame_reverse", True)
        Return
    }Else if (data > 0){
        MoveMouseAndClick("pos_tracking_one_frame_forward", True)
        Return
    }
}
...
_trackingNextKeyframe(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_tracking_next_keyframe", True)
}
...
_trackingAddRemoveKeyframe(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_tracking_add_remove_keyframe", True)
}
...
_trackingPreviousKeyframe(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_tracking_previous_keyframe", True)
}
...
_trackingRemovePoint(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_tracking_remove_point", True)    
}
...
_trackingAddPoint(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_tracking_add_point", True)
}
...
_trackingTrackReverseForward(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_tracking_reverse_forward", True)
}
...
_trackingTrackForward(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_tracking_forward", True)
}
...
_trackingStopTracking(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_tracking_stop", True)
}
...
_trackingTrackReverse(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_tracking_reverse", True)
}
...
_cwResetColorWarper(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_reset_all", True)
}
...
_cwChrLumSmoothChroma(oscType, data, msgID, hwnd){
    if (data == 0){
        ...
        MoveMouseAndClick("pos_color_warper_chrxlum_chroma_feather", True)
    }
}
...
_cwChrLumSmoothLum(oscType, data, msgID, hwnd){
    if (data == 0){
        ...
        MoveMouseAndClick("pos_color_warper_chrxlum_lum_feather", True)
    }
}
...
_cwChrLumSelect(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_chrxlum_select", True)
}
...
_cwChrLumDraw(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_chrxlum_draw", True)
}
...
_cwChrLumPinDepin(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_chrxlum_pin", True)
}
...
_cwChrLumPullPoints(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_chrxlum_pull", True)
}
...
_cwChrLumPushPoints(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_chrxlum_push", True)
}
...
_cwChrLumIncreaseFalloff(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_chrxlum_increase_falloff", True)
}
...
_cwChrLumDecreaseFalloff(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_chrxlum_decrease_falloff", True)
}
...
_cwChrLumInvertSelection(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_chrxlum_invert_selection", True)
}
...
_cwChrLumConvertToPin(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_chrxlum_convert_to_pin", True)
}
...
_cwChrLumSelectPinColumn(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_chrxlum_pin_column", True)
}
...
_cwChrLumSelectPinRow(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_chrxlum_pin_row", True)
}
...
_cwChrLumSelectDeselectAll(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_chrxlum_select_all", True)
}
...
_cwChrLumResetSelection(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_chrxlum_reset_selection", True)
}
...
_cwChrLumAutoLock(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_chrxlum_auto_lock", True)
}
...
_cwChrLumAutoPinColumns(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_chrxlum_auto_pin_columns", True)
}
...
_cwChrLumAutoPinRows(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_chrxlum_auto_pin_rows", True)
}
...
_cwChrLumAutoPinSingle(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_chrxlum_auto_pin_single", True)
}
...
_cwHueSatSmoothHue(oscType, data, msgID, hwnd){
    if (data == 0){
        ...
        MoveMouseAndClick("pos_color_warper_huexsat_hue_feather", True)
    }
}
...
_cwHueSatSmoothSat(oscType, data, msgID, hwnd){
    if (data == 0){
        ...
        MoveMouseAndClick("pos_color_warper_huexsat_sat_feather", True)
    }
}
...
_cwHueSatSelect(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_huexsat_select", True)
}
...
_cwHueSatDraw(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_huexsat_draw", True)
}
...
_cwHueSatPinDepin(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_huexsat_pin", True)
}
...
_cwHueSatPullPoints(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_huexsat_pull", True)
}
...
_cwHueSatPushPoints(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_huexsat_push", True)
}
...
_cwHueSatIncreaseFalloff(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_huexsat_increase_falloff", True)
}
...
_cwHueSatDecreaseFalloff(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_huexsat_decrease_falloff", True)
}
...
_cwHueSatInvertSelection(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_huexsat_invert_selection", True)
}
...
_cwHueSatConvertToPin(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_huexsat_convert_to_pin", True)
}
...
_cwHueSatSelectPinColumn(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_huexsat_pin_column", True)
}
...
_cwHueSatSelectPinRing(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_huexsat_pin_ring", True)
}
...
_cwHueSatSelectDeselectAll(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_huexsat_select_all", True)
}
...
_cwHueSatResetSelection(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_huexsat_reset_selection", True)
}
...
_cwHueSatAutoLock(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_color_warper_huexsat_auto_lock", True)
}
...
;Button - Toggle on/off splines on Hue Curves Panel
_hueCurvesSplines(oscType, data, msgID, hwnd){
    if(data == 0)
    Return
    
    MoveMouseAndClick("pos_hue_curves_spline")
}
...
_hdrZoneFalloff(oscType, data, msgID, hwnd){
    if (_davinciLayoutUI == "CONDENSED"){
        OpenCloseHDRZoneCondensed(True)
    }Else{
...
;Button - Key Frame Audio Keyframe Volume
_inspectorAudioKeyFrameVolume(oscType, data, msgID, hwnd){
    if (data == 0)
    Return
    
    CheckIfInspector(False)
    
    MoveMouseAndClick("pos_inspector_audio_volume_keyframe")
}

;Button - Key Frame Audio Keyframe Pan
_inspectorAudioKeyFramePan(oscType, data, msgID, hwnd){
    if (data == 0)
    Return
    
    CheckIfInspector(False)
    
    MoveMouseAndClick("pos_inspector_audio_pan_keyframe")
}
...
;Button - Key Frame Pan
_inspectorKeyFramePan(oscType, data, msgID, hwnd){
    if (data == 0)
    Return
    
    CheckIfInspector()
    
    MoveMouseAndClick("pos_inspector_pan_keyframe")
}
...
;Knob - Increment, decrement or reset Inspector Pitch Cents - Default Knob Sensitivity: Min: 0 - Max: 200 - Step: 1 - Coarse
_inspectorAudioPitchCents(oscType, data, msgID, hwnd){
    CheckIfInspector(False)
    
    if (data == 0){
        MoveMouseAndClick("pos_inspector_audio_pitch_cents_reset")
        Return
    }Else{
        MoveMouseAndDrag(data, "x", "pos_inspector_audio_pitch_cents")
        Return
    }
}

;Knob - Increment, decrement or reset Inspector Pitch Semitones - Default Knob Sensitivity: Min: 0 - Max: 200 - Step: 1 - Coarse
_inspectorAudioPitchSemiTones(oscType, data, msgID, hwnd){
    CheckIfInspector(False)
    
    if (data == 0){
        MoveMouseAndClick("pos_inspector_audio_pitch_semi_tones_reset")
        Return
    }Else{
        MoveMouseAndDrag(data, "x", "pos_inspector_audio_pitch_semi_tones")
        Return
    }
}

;Knob - Increment, decrement or reset Inspector Pan - Default Knob Sensitivity: Min: 0 - Max: 300 - Step: 1 - Coarse
_inspectorAudioPan(oscType, data, msgID, hwnd){
    CheckIfInspector(False)
    
    if (data == 0){
        MoveMouseAndClick("pos_inspector_audio_pan_reset")
        Return
    }Else{
        MoveMouseAndDrag(data, "x", "pos_inspector_audio_pan")
        Return
    }
}

;Knob - Increment, decrement or reset Inspector Volume - Default Knob Sensitivity: Min: 0 - Max: 300 - Step: 1 - Coarse
_inspectorAudioVolume(oscType, data, msgID, hwnd){
    CheckIfInspector(False)
    
    if (data == 0){
        MoveMouseAndClick("pos_inspector_audio_volume_reset")
        Return
    }Else{
        MoveMouseAndDrag(data, "x", "pos_inspector_audio_volume")
        Return
    }
}

;Button - Turn On/Off Inspector Pan
_inspectorAudioPitchReset(oscType, data, msgID, hwnd){
    if (data == 0)
    Return
    
    CheckIfInspector(False)
    
    MoveMouseAndClick("pos_inspector_audio_pitch_reset")
}

;Button - Turn On/Off Inspector Pan
_inspectorAudioPitchOnOff(oscType, data, msgID, hwnd){
    if (data == 0)
    Return
    
    CheckIfInspector()
    
    MoveMouseAndClick("pos_inspector_audio_pitch_on_off")
}

;Button - Turn On/Off Inspector Pan
_inspectorAudioPanOnOff(oscType, data, msgID, hwnd){
    if (data == 0)
    Return
    
    CheckIfInspector()
    
    MoveMouseAndClick("pos_inspector_audio_pan_on_off")
}

;Button - Turn On/Off Inspector Volume
_inspectorAudioVolumeOnOff(oscType, data, msgID, hwnd){
    if (data == 0)
    Return
    
    CheckIfInspector()
    
    MoveMouseAndClick("pos_inspector_audio_volume_on_off")
}
...
_inspectorAnchorPointY(oscType, data, msgID, hwnd){
    ...
    if (data == 0){
        ResetForSpecificValue("pos_inspector_anchor_point_y", 0)
        Return
    }Else{
...
_inspectorAnchorPointX(oscType, data, msgID, hwnd){
    ...
    if (data == 0){
        ResetForSpecificValue("pos_inspector_anchor_point_x", 0)
        Return
    }Else{
...
_inspectorPositionY(oscType, data, msgID, hwnd){
    ...
    if (data == 0){
        ResetForSpecificValue("pos_inspector_position_y", 0)
        Return
    }Else{
...
_inspectorPositionX(oscType, data, msgID, hwnd){
    ...
    if (data == 0){
        ResetForSpecificValue("pos_inspector_position_x", 0)
        Return
    }Else{
...
_inspectorZoomY(oscType, data, msgID, hwnd){
    ...
    if (data == 0){
        ResetForSpecificValue("pos_inspector_zoom_y", 1)
        Return
    }Else{
...
_inspectorZoomX(oscType, data, msgID, hwnd){
    ...
    if (data == 0){
        ResetForSpecificValue("pos_inspector_zoom_x", 1)
        Return
    }Else{
...
_colorPageScrollThumbnails(oscType, data, msgID, hwnd){
    MoveMouseToPosition("pos_color_page_thumbnails", 0, 0)
...
GetHashsText(hash){
    Switch (_actualCurvesHashs){
        ...
        Case "4":
            For index, object in _dotsHashsArray4
            if (object.var == hash) {
                Return object
            }
    }
...
CheckIfInspector(video := True){
    if (_dualView == 1){
        if (!GetToggleStateByAID("UiMainWindow.bigBossWidget.widgetStack_Panel.WStackPage_Conform.m_pConformPanel.frameEditTopBar.stackedWidget.pageDualScreenModeTools.frameEditTopBarRightInDSM.btnEditToggleInspectorInDSM")){
            MoveMouseAndClick("pos_edit_top_bts_inspector")
        }
    }Else {
...
;Open or Close HDR Zone Window on Wide and Normal Layouts
...
;Open or Close HDR Zone Window on Condensed Layouts
OpenCloseHDRZoneCondensed(isZoneTool := False){
    if (!isZoneTool AND CheckIfHDRZoneCondensed()){
        MoveMouseAndClick("pos_hdr_wheels")
...
;Check if HDR Zone panel is opened (1) or closed (0) and if closed, open it
CheckIfHDRZoneCondensed(){
    if (GetToggleStateByAID("UiMainWindow.bigBossWidget.widgetStack_Panel.WStackPage_Color.m_pColorPanel.frameVerticalContainer.frameColorBottom.frameColorBottomToolsContainer.m_pFrameBottomMain.UiPrimaryWidgetContainer.BorderFrame.frameTabWidgetBorder.stackedWidget.colorHDRTab.colorWheelTopFrame.btnGraphsView")){
        Return True
    }Else{
        Return False
    }
...
;Count how much elements are in a Array
CountArray(array){
    arrayLenght := NumGet(&array + 4*A_PtrSize)
    MsgBox %arrayLenght%
...
;Register the time that the software was started
DemoStart(){
    ;Set a timer that close Davinci, Tangent Mapper and Control Booster after the time is end (FOR DEMO VERSION)
    #Persistent
    SetTimer, BetaClose, 300000
    
    ;Save the actual time to a variable
    timestamp := A_Now
    
    ;Write a file with the timestamp of this Control Booster instance so it can be checked when you try to open a new one
    IniDelete, %A_ScriptDir%\default_ini_files\temp\check.ini, TIMESTAMP, time
    IniWrite, %timestamp%, %A_ScriptDir%\default_ini_files\temp\check.ini, TIMESTAMP, time
    
    MsgBox THIS IS A DEMO FREE VERSION OF CONTROL BOOSTER.`n`nAFTER 5 MINUTES THE SOFTWARE WILL CLOSE YOUR DAVINCI RESOLVE, YOUR TANGENT MAPPER AND THE CONTROL BOOSTER IT SELF.`n`nPAY ATTENTION THAT THIS WILL HAPPEN AUTOMATICALLY SO KEEP YOUR PROJECT SAVED.`n`nYOU NEED WAIT 5 MINUTES UNTIL OPEN IT AGAIN.`n`nTO REMOVE THESE LIMITATIONS, PLEASE BUY THE FULL VERSION.
}

;Function to close Davinci Resolve, Tangent Mapper and Control Booster in Beta Version after the defined timer
BetaClose(){
    ;Close Davinci Resolve and Tangent Mapper
    WinClose, DaVinci Resolve
    WinClose, Tangent Mapper
    
    MsgBox CONTROL BOOSTER EVALUATION TIME OVER`n`nPLEASE BUY THE FULL VERSION OR WAIT 5 MINUTES TO START THE DEMO AGAIN.
    
    ExitApp
    return
}

;Check if it has more than 5 minutes since the last instance of Control Booster Demo Version
CheckDemoDate(){
    ;Get the timestamp of the latest time that demo version was closed
    Loop, read, %A_ScriptDir%\default_ini_files\temp\check.ini
    {
        Loop, parse, A_LoopReadLine, %A_Tab%
        {
            if (InStr(A_Loopfield, "[") == 1){
            ...
            latestTimestamp := SubStr(A_Loopfield, startingPos + 1)
            
            ;MsgBox %latestTimestamp%
            
            latestInstanceSeconds := A_Now - latestTimestamp
            
            ;Check if it has more than 5 minutes since the latest Control Booster Demo Version instance and if not, close the software
            if(latestInstanceSeconds <= 600){
                MsgBox CONTROL BOOSTER DEMO VERSION`n`nYOU NEED TO WAIT 5 MINUTES BETWEEN TWO USES.
                ExitApp
            }

            ;MsgBox "There was: " . %latestInstanceSeconds% . "seconds since the latest Control Booster instance."
        }
    }
}
...
_set_dual_view_state(){
    GuiControlGet, state, , dualViewState
    
    if (state){
        _dualView := 1
        
        SetWindowStatus("dual_view", 1)
    }Else{
        _dualView := 0
        
        SetWindowStatus("dual_view", 0)
    }
...
;Debug value of a specific variable
;F12::
    ;For index, object in _positionsArray
        ;if (object.var == testVariable){
            ;MsgBox % object.X
            ;MsgBox % object.y
        ;}            
;Return

;Debug the size of _positionsArray and create a file with his content
;F5::
    ;MsgBox % _positionsArray.MaxIndex()
    
    ;For arrayNum, array in _positionsArray
        ;For index, varxy in ["var", "x", "y"]
        ;IniWrite, % array[varxy], %A_ScriptDir%\actual_positions_array_content.ini, %_resolutionAndScale%, %_resolutionAndScale% - %arrayNum%%varxy%
;Return
