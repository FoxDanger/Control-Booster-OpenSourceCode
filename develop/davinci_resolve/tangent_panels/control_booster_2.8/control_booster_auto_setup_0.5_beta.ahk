        ...
        Loop, parse, A_LoopReadLine, %A_Tab%
        {
            ...
            if !(isAddress){
                ...
                if (clickOnEmptySpaceAfter){
                    ...
                    MouseClick Left, object.x, object.y + 500, 1, 0 ;This +500 can change for a value that indicates the position of the timeline instead preview window. This is necessary for activate the dots of keyframes on inspector window.
                    Sleep 1000
                }
            }
        }
