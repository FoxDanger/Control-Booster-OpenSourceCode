...
Gui Show, w1920 h1080, TWB 2.0.5
...
;Add or remove OSC2AHK Listeners - OSC2AHK Listerners (Latest Listener number: 53)
_osc2ahkAddOrRemoveListeners(addOrRemove := "add"){
    if (addOrRemove == "add"){
        ...
        ;DllCall("OSC2AHK.dll\addListener", AStr, "/enterPrimaries", UInt, 0x1100, UInt, oscTypeInt)
        ;OnMessage(0x1100, "_enterPrimaries")
       ;
        ;DllCall("OSC2AHK.dll\addListener", AStr, "/enterColorMode", UInt, 0x1101, UInt, oscTypeInt)
...
_inspectorLinkUnlinkZoom(oscType, data, msgID, hwnd){
    if (data == 0 OR _actualPage != "EDIT" OR _getWindow("pos_inspector_video").status != 1)
    return

    _moveMouseAndClick("pos_inspector_zoom_link")
}

;Reset all audio inspector
_inspectorAudioReset(oscType, data, msgID, hwnd){
    if (if data == 0 OR _actualPage != "EDIT" OR _getWindow("pos_edit_top_bts_inspector").status == 0 OR _getWindow("pos_inspector_video").status != 0)
    return
    
    _moveMouseAndClick("pos_inspector_audio_reset")
}

;Reset all transform inspector
_inspectorTransformReset(oscType, data, msgID, hwnd){
    if (if data == 0 OR _actualPage != "EDIT" OR _getWindow("pos_edit_top_bts_inspector").status == 0 OR _getWindow("pos_inspector_video").status != 1)
    return
    
    _moveMouseAndClick("pos_inspector_transform_reset")
}

;Increment, decrement or reset Inspector Volume - Default Knob Sensitivity: Min: 0 - Max: 1000 - Step: 1 - Between fine and medium
_inspectorAudioVolume(oscType, data, msgID, hwnd){
    if (_actualPage != "EDIT" OR _getWindow("pos_edit_top_bts_inspector").status == 0 OR _getWindow("pos_inspector_video").status != 0)
    return
...
;Open the Audio Inspector Window
_openInspectorAudio(oscType, data, msgID, hwnd){
    if (if data == 0 OR _actualPage != "EDIT" OR _getWindow("pos_edit_top_bts_inspector").status == 0)
    return
    
     ;This variable is based on pos_inspector_video but 1 means you are in the VIDEO inspector window and 0 you are in the AUDIO inspector window
    _setWindowStatus("pos_inspector_video", 0)
    
    _moveMouseAndClick("pos_inspector_audio")
}

;Open the Video Inspector Window
_openInspectorVideo(oscType, data, msgID, hwnd){
    if (if data == 0 OR _actualPage != "EDIT" OR _getWindow("pos_edit_top_bts_inspector").status == 0)
    return

     ;This variable is based on pos_inspector_video but 1 means you are in the VIDEO inspector window and 0 you are in the AUDIO inspector window
    _setWindowStatus("pos_inspector_video", 1)
    
    _moveMouseAndClick("pos_inspector_video")
}

;Turn left to flip the clip horizontally and right to flip vertically (toggle), and press the knob to reset - Default Knob Sensitivity: Min: 0 - Max: 6 - Step: 1 - Between coarse
...
;Increment, decrement or reset Inspector Yaw - Default Knob Sensitivity: Min: 0 - Max: 1000 - Step: 1 - Between fine and medium
...
;Increment, decrement or reset Inspector Anchor Point Y - Default Knob Sensitivity: Min: 0 - Max: 1000 - Step: 1 - Between fine and medium
...
;Increment, decrement or reset Inspector Anchor Point X - Default Knob Sensitivity: Min: 0 - Max: 1000 - Step: 1 - Between fine and medium
...
;Increment, decrement or reset Inspector Pitch - Default Knob Sensitivity: Min: 0 - Max: 1000 - Step: 1 - Between fine and medium
...
;Increment, decrement or reset Inspector Position Y - Default Knob Sensitivity: Min: 0 - Max: 1000 - Step: 1 - Between fine and medium
...
;Increment, decrement or reset Inspector Position X - Default Knob Sensitivity: Min: 0 - Max: 1000 - Step: 1 - Between fine and medium
...
;Increment, decrement or reset Inspector Rotation Angle - Default Knob Sensitivity: Min: 0 - Max: 1000 - Step: 1 - Between fine and medium
...
;Increment, decrement or reset Inspector Zoom Y - Default Knob Sensitivity: Min: 0 - Max: 1000 - Step: 1 - Between fine and medium
...
;Increment, decrement or reset Inspector Zoom X - Default Knob Sensitivity: Min: 0 - Max: 1000 - Step: 1 - Between fine and medium
