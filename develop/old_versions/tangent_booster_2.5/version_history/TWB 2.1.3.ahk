...
Gui Show, w1920 h1080, TWB 2.1.3
...
;Add or remove OSC2AHK Listeners - OSC2AHK Listerners (Latest Listener used on low range: 0x1382 - Latest Listener used on high range: 0x1533)
Osc2ahkAddOrRemoveListeners(addOrRemove := "add"){
    if (addOrRemove == "add"){
        ...
        DllCall("OSC2AHK.dll\addListener", AStr, "/paste", UInt, 0x1006, UInt, oscTypeInt)
        OnMessage(0x1006, "_paste")
        ...
        DllCall("OSC2AHK.dll\removeListener", AStr, "/paste", UInt, 0x1006, UInt, oscTypeInt)
        OnMessage(0x1006, "_paste")
