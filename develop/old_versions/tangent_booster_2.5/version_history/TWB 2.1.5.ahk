...
;Set the actual Hue Curves panel. Can be: "HSL" or "RGB"
Global _actualQualifierPanel := "HSL"

;Set the actual Matte Finesse page on Qualifier Panel. Can be: "1" or "2"
Global _actualMatteFinessePage := 1

;Set the actual Matte Finesse page on Qualifier Panel. Can be: "1" (Shrink), "2" (Grow), "3" (Opening), "4" (Closing)
Global _actualMatteFinesseMode := 1

;Set the actual Matte Finesse Shape on Qualifier Panel. Can be: "1" (Square), "2" (Circle - Default), "3" (Diamond)
Global _actualMatteFinesseShape := 2
...
Gui Add, Picture, x740 y592 w440 h65, E:\André Rodrigues\Media Environment\Produtos\TWB 2.0\images\Color Interface Tools.png
Gui Add, Button, g_set_variable_button vpos_color_interface_tools_cursor_mode x736 y528 w120 h50, Cursor Mode
Gui Add, Button, g_set_variable_button vpos_color_interface_tools_hand_mode x864 y528 w120 h50, Hand Mode
Gui Add, Button, g_set_variable_button vpos_color_interface_tools_node_mode_1 x712 y672 w120 h50, Nodes Mode 1
Gui Add, Button, g_set_variable_button vpos_color_interface_tools_node_mode_2 x840 y672 w120 h50, Nodes Mode 2
Gui Add, Button, g_set_variable_button vpos_color_interface_tools_node_mode_3 x968 y672 w120 h50, Nodes Mode 3
Gui Add, Button, g_set_variable_button vpos_color_interface_tools_node_mode_4 x1096 y672 w120 h50, Nodes Mode 4
...
Gui Add, Button, g_set_variable_button vpos_qualifier_hsl_dot x760 y368 w150 h50, Qualifier HSL Dot
Gui Add, Button, g_set_variable_button vpos_qualifier_rgb_dot x920 y368 w150 h50, Qualifier RGB Dot
Gui Add, Button, g_set_variable_button vpos_qualifier_reset x1280 y368 w150 h50, Qualifier Reset
Gui Add, Button, g_set_variable_button vpos_qualifier_picker x1440 y460 w150 h50, Qualifier Picker
Gui Add, Button, g_set_variable_button vpos_qualifier_picker_substract x1440 y524 w150 h50, Qualifier Picker Substract
Gui Add, Button, g_set_variable_button vpos_qualifier_picker_add x1440 y588 w150 h50, Qualifier Picker Add
Gui Add, Button, g_set_variable_button vpos_qualifier_feather_substract x1440 y652 w150 h50, Qualifier Feather Substract
...
Gui Add, Button, g_set_variable_button vpos_scopes_button x760 y400 w150 h50, Scopes Button
...
Gui Show, w1920 h1080, TWB 2.1.5
...
Osc2ahkAddOrRemoveListeners(addOrRemove := "add"){
    if (addOrRemove == "add"){
        ...
        OnMessage(0x2051, "_resetAllNodesGrade") ;Latest high

        ;Qualifier Listeners
        DllCall("OSC2AHK.dll\addListener", AStr, "/matteFinesseDenoise", UInt, 0x1446, UInt, oscTypeInt)
        OnMessage(0x1446, "_matteFinesseDenoise") ;Latest Low
        ...
        DllCall("OSC2AHK.dll\addListener", AStr, "/matteFinesseMode", UInt, 0x1441, UInt, oscTypeInt)
        OnMessage(0x1441, "_matteFinesseMode")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/matteFinesseShape", UInt, 0x1440, UInt, oscTypeInt)
        OnMessage(0x1440, "_matteFinesseShape")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/matteFinesseRadius", UInt, 0x1439, UInt, oscTypeInt)
        OnMessage(0x1439, "_matteFinesseRadius")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/matteFinesseIterations", UInt, 0x1438, UInt, oscTypeInt)
        OnMessage(0x1438, "_matteFinesseIterations")
        ...
        DllCall("OSC2AHK.dll\addListener", AStr, "/copyCut", UInt, 0x1018, UInt, oscTypeInt)
        OnMessage(0x1018, "_copyCut")
        ...
        ;All Panels Listeners
        DllCall("OSC2AHK.dll\removeListener", AStr, "/undo", UInt, 0x1500, UInt, oscTypeInt)
        OnMessage(0x1500, "_undo")

        DllCall("OSC2AHK.dll\removeListener", AStr, "/redo", UInt, 0x1501, UInt, oscTypeInt)
        OnMessage(0x1501, "_redo")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/colorPageScrollThumbnails", UInt, 0x1502, UInt, oscTypeInt)
        OnMessage(0x1502, "_colorPageScrollThumbnails")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/navigateNodes", UInt, 0x1503, UInt, oscTypeInt)
        OnMessage(0x1503, "_navigateNodes")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/resetDefaultState", UInt, 0x1504, UInt, oscTypeInt)
        OnMessage(0x1504, "_resetDefaultState")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/enableDisableSelectedNodes", UInt, 0x1505, UInt, oscTypeInt)
        OnMessage(0x1505, "_enableDisableSelectedNodes")

        DllCall("OSC2AHK.dll\removeListener", AStr, "/bypassColorGrading", UInt, 0x1506, UInt, oscTypeInt)
        OnMessage(0x1506, "_bypassColorGrading")

        DllCall("OSC2AHK.dll\removeListener", AStr, "/playheadA", UInt, 0x1507, UInt, oscTypeInt)
        OnMessage(0x1507, "_playheadA")

        DllCall("OSC2AHK.dll\removeListener", AStr, "/playheadB", UInt, 0x1508, UInt, oscTypeInt)
        OnMessage(0x1508, "_playheadB")

        DllCall("OSC2AHK.dll\removeListener", AStr, "/playheadC", UInt, 0x1509, UInt, oscTypeInt)
        OnMessage(0x1509, "_playheadC")

        DllCall("OSC2AHK.dll\removeListener", AStr, "/playheadD", UInt, 0x1510, UInt, oscTypeInt)
        OnMessage(0x1510, "_playheadD")

        DllCall("OSC2AHK.dll\removeListener", AStr, "/resetPlayheads", UInt, 0x1511, UInt, oscTypeInt)
        OnMessage(0x1511, "_resetPlayheads")

        DllCall("OSC2AHK.dll\removeListener", AStr, "/rippleNodesToSelectedClips", UInt, 0x1512, UInt, oscTypeInt)
        OnMessage(0x1512, "_rippleNodesToSelectedClips")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/fastNavigateClips", UInt, 0x1513, UInt, oscTypeInt)
        OnMessage(0x1513, "_fastNavigateClips")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/deleteKey", UInt, 0x1514, UInt, oscTypeInt)
        OnMessage(0x1514, "_deleteKey")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/backspaceKey", UInt, 0x1515, UInt, oscTypeInt)
        OnMessage(0x1515, "_backspaceKey")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/colorInterfaceImageWipe", UInt, 0x1516, UInt, oscTypeInt)
        OnMessage(0x1516, "_colorInterfaceImageWipe")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/colorInterfaceSplitScreen", UInt, 0x1517, UInt, oscTypeInt)
        OnMessage(0x1517, "_colorInterfaceSplitScreen")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/colorInterfaceHighlight", UInt, 0x1518, UInt, oscTypeInt)
        OnMessage(0x1518, "_colorInterfaceHighlight")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/colorInterfaceZoomView", UInt, 0x1519, UInt, oscTypeInt)
        OnMessage(0x1519, "_colorInterfaceZoomView")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/colorInterfaceCursorHand", UInt, 0x1520, UInt, oscTypeInt)
        OnMessage(0x1520, "_colorInterfaceCursorHand")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/colorInterfaceNodeMode1", UInt, 0x1521, UInt, oscTypeInt)
        OnMessage(0x1521, "_colorInterfaceNodeMode1")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/colorInterfaceNodeMode2", UInt, 0x1522, UInt, oscTypeInt)
        OnMessage(0x1522, "_colorInterfaceNodeMode2")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/colorInterfaceNodeMode3", UInt, 0x1523, UInt, oscTypeInt)
        OnMessage(0x1523, "_colorInterfaceNodeMode3")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/colorInterfaceNodeMode4", UInt, 0x1524, UInt, oscTypeInt)
        OnMessage(0x1524, "_colorInterfaceNodeMode4")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/colorInterfaceGallery", UInt, 0x1525, UInt, oscTypeInt)
        OnMessage(0x1525, "_colorInterfaceGallery")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/colorInterfaceLuts", UInt, 0x1526, UInt, oscTypeInt)
        OnMessage(0x1526, "_colorInterfaceLuts")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/colorInterfaceMediaPool", UInt, 0x1527, UInt, oscTypeInt)
        OnMessage(0x1527, "_colorInterfaceMediaPool")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/colorInterfaceTimeline", UInt, 0x1528, UInt, oscTypeInt)
        OnMessage(0x1528, "_colorInterfaceTimeline")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/colorInterfaceClips", UInt, 0x1529, UInt, oscTypeInt)
        OnMessage(0x1529, "_colorInterfaceClips")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/colorInterfaceNodes", UInt, 0x1530, UInt, oscTypeInt)
        OnMessage(0x1530, "_colorInterfaceNodes")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/colorInterfaceOpenFX", UInt, 0x1531, UInt, oscTypeInt)
        OnMessage(0x1531, "_colorInterfaceOpenFX")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/colorInterfaceLightbox", UInt, 0x1532, UInt, oscTypeInt)
        OnMessage(0x1532, "_colorInterfaceLightbox")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/colorInterfaceImageWipeMode", UInt, 0x1533, UInt, oscTypeInt)
        OnMessage(0x1533, "_colorInterfaceImageWipeMode")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/projectSettings", UInt, 0x1534, UInt, oscTypeInt)
        OnMessage(0x1534, "_projectSettings")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/projectSelection", UInt, 0x1535, UInt, oscTypeInt)
        OnMessage(0x1535, "_projectSelection")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/davinciSettings", UInt, 0x1536, UInt, oscTypeInt)
        OnMessage(0x1536, "_davinciSettings")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/copy", UInt, 0x1537, UInt, oscTypeInt)
        OnMessage(0x1537, "_copy")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/paste", UInt, 0x1538, UInt, oscTypeInt)
        OnMessage(0x1538, "_paste")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/grabStill", UInt, 0x1539, UInt, oscTypeInt)
        OnMessage(0x1539, "_grabStill")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/applyGrade", UInt, 0x1540, UInt, oscTypeInt)
        OnMessage(0x1540, "_applyGrade")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/fullView", UInt, 0x1541, UInt, oscTypeInt)
        OnMessage(0x1541, "_fullView")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/stepFrame", UInt, 0x1542, UInt, oscTypeInt)
        OnMessage(0x1542, "_stepFrame")

        DllCall("OSC2AHK.dll\removeListener", AStr, "/previousClip", UInt, 0x1543, UInt, oscTypeInt)
        OnMessage(0x1543, "_previousClip")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/nextClip", UInt, 0x1544, UInt, oscTypeInt)
        OnMessage(0x1544, "_nextClip")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/resetAllNodesGradeAndKeepNodes", UInt, 0x1545, UInt, oscTypeInt)
        OnMessage(0x1545, "_resetAllNodesGradeAndKeepNodes")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/resetNodeGrade", UInt, 0x1546, UInt, oscTypeInt)
        OnMessage(0x1546, "_resetNodeGrade")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/playBackward", UInt, 0x1547, UInt, oscTypeInt)
        OnMessage(0x1547, "_playBackward")
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/stop", UInt, 0x1548, UInt, oscTypeInt)
        OnMessage(0x1548, "_stop")
    
        DllCall("OSC2AHK.dll\removeListener", AStr, "/playForward", UInt, 0x1549, UInt, oscTypeInt)
        OnMessage(0x1549, "_playForward")
        
        ;DllCall("OSC2AHK.dll\removeListener", AStr, "/startStop", UInt, 0x1550, UInt, oscTypeInt)
        ;OnMessage(0x1550, "_startStop") ;This listener should never be removed or you can't go back and re-start the software, so keep this commented.
        
        DllCall("OSC2AHK.dll\removeListener", AStr, "/resetAllNodesGrade", UInt, 0x1551, UInt, oscTypeInt)
        OnMessage(0x1551, "_resetAllNodesGrade")
        ...
        DllCall("OSC2AHK.dll\removeListener", AStr, "/_goToInspectorWindow", UInt, 0x1044, UInt, oscTypeInt)
        OnMessage(0x1044, "_goToInspectorWindow")
        ...
        DllCall("OSC2AHK.dll\removeListener", AStr, "/copyCut", UInt, 0x1018, UInt, oscTypeInt)
        OnMessage(0x1018, "_copyCut")
...
;Knob - Increment, decrement or reset White Clip at Page 2 of Matte Finesse on Qualifier HSL Panel - Default Knob Sensitivity: Min: 0 - Max: 1000 - Step: 1 - Coarse
_matteFinesseWhiteClip(oscType, data, msgID, hwnd){
    ChangeMatteFinessePage(2)

    if (data == 0){
        MoveMouseAndClick("pos_matte_finesse_2_white_clip_reset")
        Return
    }Else{
        MoveMouseAndDrag(data, "x", "pos_matte_finesse_2_white_clip")
        Return
    }
}

;Knob - Increment, decrement or reset Black Clip at Page 2 of Matte Finesse on Qualifier HSL Panel - Default Knob Sensitivity: Min: 0 - Max: 1000 - Step: 1 - Coarse
_matteFinesseBlackClip(oscType, data, msgID, hwnd){
    ChangeMatteFinessePage(2)
    
    if (data == 0){
        MoveMouseAndClick("pos_matte_finesse_2_black_clip_reset")
        Return
    }Else{
        MoveMouseAndDrag(data, "x", "pos_matte_finesse_2_black_clip")
        Return
    }
}

;Knob - Increment, decrement or reset Iterations at Page 2 of Matte Finesse on Qualifier HSL Panel - Default Knob Sensitivity: Min: 0 - Max: 1000 - Step: 1 - Coarse
_matteFinesseIterations(oscType, data, msgID, hwnd){
    ChangeMatteFinessePage(2)
    
    if (data == 0){
        MoveMouseAndClick("pos_matte_finesse_2_iterations_reset")
        Return
    }Else{
        MoveMouseAndDrag(data, "x", "pos_matte_finesse_2_iterations")
        Return
    }
}

;Knob - Increment, decrement or reset Radius at Page 2 of Matte Finesse on Qualifier HSL Panel - Default Knob Sensitivity: Min: 0 - Max: 1000 - Step: 1 - Coarse
_matteFinesseRadius(oscType, data, msgID, hwnd){
    ChangeMatteFinessePage(2)
    
    if (data == 0){
        MoveMouseAndClick("pos_matte_finesse_2_radius_reset")
        Return
    }Else{
        MoveMouseAndDrag(data, "x", "pos_matte_finesse_2_radius")
        Return
    }
}

;Knob - Change the options or reset Shape at Page 2 of Matte Finesse on Qualifier HSL Panel - Default Knob Sensitivity: Min: 0 - Max: 20 - Step: 1 - Coarse
_matteFinesseShape(oscType, data, msgID, hwnd){
    ChangeMatteFinessePage(2)

    if (data == 0){
        MoveMouseAndClick("pos_matte_finesse_2_shape_reset")
        _actualMatteFinesseShape := 2
        Return
    }Else if(data < 0){
        if (_actualMatteFinesseShape <= 1){
            _actualMatteFinesseShape := 3
        }Else{
            _actualMatteFinesseShape--
        }
    }Else if(data > 0){
        if (_actualMatteFinesseShape >= 3){
            _actualMatteFinesseShape := 1
        }Else{
            _actualMatteFinesseShape++
        }
    }
    
    MoveMouseAndClick("pos_matte_finesse_2_shape_menu")
    
    Switch (_actualMatteFinesseShape){
        Case "1":
            MoveMouseAndClick("pos_matte_finesse_2_square")            
        Return
        Case "2":
            MoveMouseAndClick("pos_matte_finesse_2_circle")            
        Return
        Case "3":
            MoveMouseAndClick("pos_matte_finesse_2_diamond")            
        Return
    }
}

;Knob - Change the options or reset Mode at Page 2 of Matte Finesse on Qualifier HSL Panel - Default Knob Sensitivity: Min: 0 - Max: 20 - Step: 1 - Coarse
_matteFinesseMode(oscType, data, msgID, hwnd){
    ChangeMatteFinessePage(2)

    if (data == 0){
        MoveMouseAndClick("pos_matte_finesse_2_mode_reset")
    ...
    MoveMouseAndClick("pos_matte_finesse_2_mode_menu")
...
_matteFinesseInOutRatio(oscType, data, msgID, hwnd){
    ...
    if (data == 0){
        MoveMouseAndClick("pos_matte_finesse_1_in_out_ratio_reset")
        Return
    }Else{
...
_matteFinesseBlurRadius(oscType, data, msgID, hwnd){
    ...
    if (data == 0){
        MoveMouseAndClick("pos_matte_finesse_1_blur_radius_reset")
        Return
    }Else{
...
_matteFinesseCleanWhite(oscType, data, msgID, hwnd){
    ...
    if (data == 0){
        MoveMouseAndClick("pos_matte_finesse_1_clean_white_reset")
        Return
    }Else{
...
_matteFinesseCleanBlack(oscType, data, msgID, hwnd){
    ...
    if (data == 0){
        MoveMouseAndClick("pos_matte_finesse_1_clean_black_reset")
        Return
    }Else{
...
;Knob - Increment, decrement or reset Denoise at Page 1 of Matte Finesse on Qualifier HSL Panel - Default Knob Sensitivity: Min: 0 - Max: 1000 - Step: 1 - Coarse
_matteFinesseDenoise(oscType, data, msgID, hwnd){
    ChangeMatteFinessePage(1)
    
    if (data == 0){
        MoveMouseAndClick("pos_matte_finesse_1_denoise_reset")
        Return
    }Else{
        MoveMouseAndDrag(data, "x", "pos_matte_finesse_1_denoise")
        Return
    }
}
...
_qualifierBlueHighSoft(oscType, data, msgID, hwnd){
    if (CheckIfColorPanel("QUALIFIERRGB") == false)
    Return
...
_qualifierLumHighSoft(oscType, data, msgID, hwnd){
    if (CheckIfColorPanel("QUALIFIERHSL") == false)
    Return
...
_qualifierReset(oscType, data, msgID, hwnd){
    if (CheckIfQualifierPanelOrData0(data) == false)
    Return
...
_scopesCIE(oscType, data, msgID, hwnd){
    ...
    MoveMouseAndClick("pos_scopes_button")
    Sleep 10
...
_hdrFalloffThirdWheel(oscType, data, msgID, hwnd){
    ...
    if (data == 0){
        MoveMouseAndDoubleClick("pos_hdr_third_wheel_falloff")
        Return
    }Else{
...
_hdrFalloffSecondWheel(oscType, data, msgID, hwnd){
    ...
    if (data == 0){
        MoveMouseAndDoubleClick("pos_hdr_second_wheel_falloff")
        Return
    }Else{
...
_hdrFalloffFirstWheel(oscType, data, msgID, hwnd){
    ...
    if (data == 0){
        MoveMouseAndDoubleClick("pos_hdr_first_wheel_falloff")
        Return
    }Else{
...
;Cut (left), copy (right) - Davinci Resolve default shortcut: Ctrl + C / Ctrl + X - Default Knob Sensitivity: Min: 0 - Max: 8 - Step: 1 - Coarse
_copyCut(oscType, data, msgID, hwnd){
    if (data == 0){
        Return
    }Else if (data < 0){
        Send ^{x}
...
ChangeColorPanel(panel){
    ...
    Switch (panel){
        ...
        Case "QUALIFIERHSL":
            ...
            _actualColorPanel := "QUALIFIERHSL"
        ...
        Case "QUALIFIERRGB":
            ...
            _actualColorPanel := "QUALIFIERRGB"
...
;Change the Qualifier panel from HSL to RGB or vice-versa. Saves the status on windows_status.ini over the "actual_qualifier_panel" variable name.
ChangeQualifierPanel(panel){
    if (_actualColorPanel == panel)
    Return True
    
    object := GetWindow("actual_qualifier_panel")

    if (_actualColorPanel == "QUALIFIERHSL" AND object.status != 1){
        ChangeColorPanel("QUALIFIERHSL")

        MoveMouseAndClick("pos_qualifier_hsl_dot")
        
        SetWindowStatus(object.var, 1)
    }Else if (_actualColorPanel == "QUALIFIERRGB" AND object.status != 0){
        ChangeColorPanel("QUALIFIERHSL")
...
;Toggle between Qualifier Panels - 1 for HSL and 0 for RGB
CheckIfQualifierPanelOpen(panel){
    if (GetWindow(panel).status == 0){
        OpenCloseWindow("actual_qualifier_panel", 1)
        
        _actualQualifierPanel := "HSL"
    }Else{
        OpenCloseWindow("actual_qualifier_panel", 0)
        
        _actualQualifierPanel := "RGB"
    }
}
...
;Check if data is 0 and return false, if not 0 check if _actualPage is EDIT, if it is, change page to COLOR and return false (so the command is not executed for safety reasons). After that, check if the _actualMode is "QUALIFIER" and if not, it changes for "QUALIFIER" and return true.
CheckIfQualifierPanelOrData0(data){
    if (data == 0)
    Return False
...
;Check if data is 0 and return false, if not 0 check if _actualPage is EDIT, if it is return false so it changes the page to edit but doesn't execute the command for safety reasons or return true instead
