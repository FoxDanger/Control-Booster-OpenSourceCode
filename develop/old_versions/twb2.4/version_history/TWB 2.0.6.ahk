...
Gui Show, w1920 h1080, TWB 2.0.6
...
;Add or remove OSC2AHK Listeners - OSC2AHK Listerners (Latest Listener used: 0x1124)
_osc2ahkAddOrRemoveListeners(addOrRemove := "add"){
    if (addOrRemove == "add"){
        ...
        DllCall("OSC2AHK.dll\addListener", AStr, "/redo", UInt, 0x1011, UInt, oscTypeInt)
        OnMessage(0x1011, "_redo")
        ...
        DllCall("OSC2AHK.dll\addListener", AStr, "/moveHDRFourthWheelY", UInt, 0x1071, UInt, oscTypeInt)
        OnMessage(0x1071, "_moveHDRFourthWheelY")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/moveHDRFourthWheelX", UInt, 0x1070, UInt, oscTypeInt)
        OnMessage(0x1070, "_moveHDRFourthWheelX")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/moveHDRThirdWheelY", UInt, 0x1069, UInt, oscTypeInt)
        OnMessage(0x1069, "_moveHDRThirdWheelY")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/moveHDRThirdWheelX", UInt, 0x1068, UInt, oscTypeInt)
        OnMessage(0x1068, "_moveHDRThirdWheelX")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/moveHDRSecondWheelY", UInt, 0x1067, UInt, oscTypeInt)
        OnMessage(0x1067, "_moveHDRSecondWheelY")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/moveHDRSecondWheelX", UInt, 0x1066, UInt, oscTypeInt)
        OnMessage(0x1066, "_moveHDRSecondWheelX")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/moveHDRFirstWheelY", UInt, 0x1065, UInt, oscTypeInt)
        OnMessage(0x1065, "_moveHDRFirstWheelY")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/moveHDRFirstWheelX", UInt, 0x1064, UInt, oscTypeInt)
        OnMessage(0x1064, "_moveHDRFirstWheelX")
...
_moveHDRFourthWheelY(oscType, data, msgID, hwnd){
    if (_checkIfColorPanel("HDR") == false)
    Return
...
_moveHDRFourthWheelX(oscType, data, msgID, hwnd){
    if (_checkIfColorPanel("HDR") == false)
    Return
...
_moveHDRThirdWheelY(oscType, data, msgID, hwnd){
    if (_checkIfColorPanel("HDR") == false)
    Return
...
_moveHDRThirdWheelX(oscType, data, msgID, hwnd){
    if (_checkIfColorPanel("HDR") == false)
    Return
...
_moveHDRSecondWheelY(oscType, data, msgID, hwnd){
    if (_checkIfColorPanel("HDR") == false)
    Return
...
_moveHDRSecondWheelX(oscType, data, msgID, hwnd){
    if (_checkIfColorPanel("HDR") == false)
    Return
...
_moveHDRFirstWheelY(oscType, data, msgID, hwnd){
    if (_checkIfColorPanel("HDR") == false)
    Return
...
_moveHDRFirstWheelX(oscType, data, msgID, hwnd){
    if (_checkIfColorPanel("HDR") == false)
    Return
