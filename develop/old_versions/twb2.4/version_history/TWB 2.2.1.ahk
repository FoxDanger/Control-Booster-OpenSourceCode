...
Gui Show, w1920 h1080, TWB 2.2.1
...
Osc2ahkAddOrRemoveListeners(addOrRemove := "add"){
    if (addOrRemove == "add"){
        ...
        DllCall("OSC2AHK.dll\addListener", AStr, "/toggleTimlineThumbMode", UInt, 0x1496, UInt, oscTypeInt)
        OnMessage(0x1496, "_toggleTimlineThumbMode")
        ...
        DllCall("OSC2AHK.dll\removeListener", AStr, "/toggleTimlineThumbMode", UInt, 0x1496, UInt, oscTypeInt)
        OnMessage(0x1496, "_toggleTimlineThumbMode")
...
_toggleTimlineThumbMode(oscType, data, msgID, hwnd){
    if (data == 0)
    Return
