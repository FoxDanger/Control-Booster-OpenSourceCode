...
Gui Show, w1920 h1080, TWB 2.1.1
...
;Add or remove OSC2AHK Listeners - OSC2AHK Listerners (Latest Listener used: 0x1296)
...
;Reset Davinci UI Layout, reset all variables to default states and put Davinci on Full Screen Mode (IMPORTANT: You have to manually put Custom Curves Edit on LINKED mode after use this function) - This function use 2 non default Davinci Shortcuts - Ctrl + F1 and Ctrl + F2 for the Workspace menu options: Reset UI Layout and Full Screen Window
