...
Osc2ahkAddOrRemoveListeners(addOrRemove := "add"){
    if (addOrRemove == "add"){
        ...
        OnMessage(0x2052, "_enableDisableAllNodes") ;Latest High
        ...
        OnMessage(0x1497, "_openKeyFrameWindowColorPage") ;Latest Low
        ...
        OnMessage(0x1495, "_pasteAttributesJogWheel") ;Latest Low
        ...
        DllCall("OSC2AHK.dll\removeListener", AStr, "/_copyJogWheel", UInt, 0x1492, UInt, oscTypeInt)
        OnMessage(0x1492, "_copyJogWheel")
