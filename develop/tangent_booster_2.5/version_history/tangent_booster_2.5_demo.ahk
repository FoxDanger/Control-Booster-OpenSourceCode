...
;- Input Hue needs a speed up on alt key and not a speed down
;- Hue x Sat Curve needs a speed up on alt key and not a speed down
;- Input Sat and Lum speeds needs be toggle the normal for the alt key
;- Chroma x Luma Color Warp needs a faster speed of Chroma Axis
...
;Instructions about Tangent Booster:
...
;Save all the listeners being used by Tangent Booster
...
Loop, read, %A_ScriptDir%\tb_osc_address.ini
{
    Loop, parse, A_LoopReadLine, %A_Tab%
    {
...
Gui Tab, 33
Gui Add, Picture, x480 y480 w950 h400, F:\André Rodrigues\Media Environment\Produtos\TWB 2 - Develop\GIT\develop\tangent_booster_2.5_beta\images\Sizing Input.png
...
StartOSC2AHK(){
    ...
    ;Add a exclusive listener for Start/Stop the Tangent Booster that will never be removed
...
;***** End Of RGB Mixer mode functions *****
...
;***** Extra Functions for Trackballs and Jog Wheels Buttons *****
...
;***** End of Extra Functions for Trackballs and Jog Wheels Buttons *****
