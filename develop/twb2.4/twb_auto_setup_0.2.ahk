;TWB Auto Setup
;A software to generate a new resolution/scale setup for TWB 2
...
;Set the type of Davinci Layout according the PC resolution - Boolean - True if it is the normal Davinci UI and False if it is the condensed Davinci UI
Global _normalLayout := True
...
Gui Show, w720 h640, TWB Auto Setup 0.2
...
FirstSetup(){
    ...
    Gui Add, Text, x0 y0 w720 h640
    Gui Add, Text, x0 y100 w1280 h3 +0x10
    Gui Add, Text, x0 y0 w720 h100 +0x200 +Center, How's your Davinci UI looks like on color page?
    Gui Add, Picture, x368 y250 w350 h197, F:\André Rodrigues\Media Environment\Produtos\TWB 2 - Develop\GIT\develop\twb_position_generator\images\step-by-step\davinci_condensed_interface.png
    Gui Add, Picture, x5 y250 w350 h197, F:\André Rodrigues\Media Environment\Produtos\TWB 2 - Develop\GIT\develop\twb_position_generator\images\step-by-step\davinci_normal_interface.png
...
startUserPositions(){
    ...
    Switch (_actualTool){
        Case 1:
            ...
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over an empty space on Media Pool
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, and hit ENTER key
            Gui Add, Picture, x5 y312 w710 h319, %A_ScriptDir%\images\step-by-step\pos_media_pool_empty_space.png
        Case 2:
            _actualObject := "pos_timeline_time_bar"

            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the timeline time bar
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, and hit ENTER key
            Gui Add, Picture, x5 y368 w710 h259, %A_ScriptDir%\images\step-by-step\pos_timeline_time_bar.png
        Case 3:
            _actualObject := "pos_color_interface_tools_node_mode_menu"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the nodes groups menu
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, and hit ENTER key
            Gui Add, Picture, x193 y384 w334 h246, %A_ScriptDir%\images\step-by-step\pos_color_interface_tools_node_mode_menu.png
        Case 4:
            _actualObject := "pos_color_interface_tools_node_mode_1"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, On color page create a group for some clip and select that clip, put your
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, mouse over the option "Group Pre-clip" on nodes menu and hit ENTER key
            Gui Add, Picture, x193 y384 w334 h246, %A_ScriptDir%\images\step-by-step\pos_color_interface_tools_node_mode_1.png
        Case 5:
            _actualObject := "pos_color_interface_tools_node_mode_2"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the option "clip"
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, on nodes menu and hit ENTER key
            Gui Add, Picture, x193 y384 w334 h246, %A_ScriptDir%\images\step-by-step\pos_color_interface_tools_node_mode_2.png
        Case 6:
            _actualObject := "pos_color_interface_tools_node_mode_3"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the option "Group Post-clip"
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, on nodes menu and hit ENTER key
            Gui Add, Picture, x193 y384 w334 h246, %A_ScriptDir%\images\step-by-step\pos_color_interface_tools_node_mode_3.png
        Case 7:
            _actualObject := "pos_color_interface_tools_node_mode_4"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the option "timeline"
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, on nodes menu and hit ENTER key
            Gui Add, Picture, x193 y384 w334 h246, %A_ScriptDir%\images\step-by-step\pos_color_interface_tools_node_mode_4.png
        Case 8:
            _actualObject := "pos_zone_on_off_black"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the on/off button of black zone
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, at the zone panel and hit ENTER key
            Gui Add, Picture, x130 y192 w460 h437, %A_ScriptDir%\images\step-by-step\pos_zone_on_off_black.png
        Case 9:
            _actualObject := "pos_zone_on_off_dark"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the on/off button of dark zone
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, at the zone panel and hit ENTER key
            Gui Add, Picture, x130 y192 w460 h437, %A_ScriptDir%\images\step-by-step\pos_zone_on_off_dark.png
        Case 10:
            _actualObject := "pos_zone_on_off_shadow"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the on/off button of shadow zone
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, at the zone panel and hit ENTER key
            Gui Add, Picture, x130 y192 w460 h437, %A_ScriptDir%\images\step-by-step\pos_zone_on_off_shadow.png
        Case 11:
            _actualObject := "pos_zone_on_off_light"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the on/off button of light zone
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, at the zone panel and hit ENTER key
            Gui Add, Picture, x130 y192 w460 h437, %A_ScriptDir%\images\step-by-step\pos_zone_on_off_light.png
        Case 12:
            _actualObject := "pos_zone_on_off_highlight"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the on/off button of highlight zone
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, at the zone panel and hit ENTER key
            Gui Add, Picture, x130 y192 w460 h437, %A_ScriptDir%\images\step-by-step\pos_zone_on_off_highlight.png
        Case 13:
            _actualObject := "pos_zone_on_off_specular"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the on/off button of specular zone
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, at the zone panel and hit ENTER key
            Gui Add, Picture, x130 y192 w460 h437, %A_ScriptDir%\images\step-by-step\pos_zone_on_off_specular.png
        Case 14:
            _actualObject := "pos_zone_show_hide_black"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the show/hide button of black zone
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, at the zone panel and hit ENTER key
            Gui Add, Picture, x130 y192 w460 h437, %A_ScriptDir%\images\step-by-step\pos_zone_show_hide_black.png
        Case 15:
            _actualObject := "pos_zone_show_hide_dark"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the show/hide button of dark zone
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, at the zone panel and hit ENTER key
            Gui Add, Picture, x130 y192 w460 h437, %A_ScriptDir%\images\step-by-step\pos_zone_show_hide_dark.png
        Case 16:
            _actualObject := "pos_zone_show_hide_shadow"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the show/hide button of shadow zone
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, at the zone panel and hit ENTER key
            Gui Add, Picture, x130 y192 w460 h437, %A_ScriptDir%\images\step-by-step\pos_zone_show_hide_shadow.png
        Case 17:
            _actualObject := "pos_zone_show_hide_light"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the show/hide button of light zone
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, at the zone panel and hit ENTER key
            Gui Add, Picture, x130 y192 w460 h437, %A_ScriptDir%\images\step-by-step\pos_zone_show_hide_light.png
        Case 18:
            _actualObject := "pos_zone_show_hide_highlight"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the show/hide button of highlight zone
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, at the zone panel and hit ENTER key
            Gui Add, Picture, x130 y192 w460 h437, %A_ScriptDir%\images\step-by-step\pos_zone_show_hide_highlight.png
        Case 19:
            _actualObject := "pos_zone_show_hide_specular"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the show/hide button of specular zone
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, at the zone panel and hit ENTER key
            Gui Add, Picture, x130 y192 w460 h437, %A_ScriptDir%\images\step-by-step\pos_zone_show_hide_specular.png
        Case 20:
            _actualObject := "pos_scopes_parade"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the option "parade"
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, on scopes menu and hit ENTER key
            Gui Add, Picture, x198 y384 w324 h244, %A_ScriptDir%\images\step-by-step\pos_scopes_parade.png
        Case 21:
            _actualObject := "pos_scopes_waveform"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the option "waveform"
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, on scopes menu and hit ENTER key
            Gui Add, Picture, x198 y384 w324 h244, %A_ScriptDir%\images\step-by-step\pos_scopes_waveform.png
        Case 22:
            _actualObject := "pos_scopes_vectorscope"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the option "vectorscope"
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, on scopes menu and hit ENTER key
            Gui Add, Picture, x198 y384 w324 h244, %A_ScriptDir%\images\step-by-step\pos_scopes_vectorscope.png
        Case 23:
            _actualObject := "pos_scopes_histogram"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the option "histogram"
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, on scopes menu and hit ENTER key
            Gui Add, Picture, x198 y384 w324 h244, %A_ScriptDir%\images\step-by-step\pos_scopes_histogram.png
        Case 24:
            _actualObject := "pos_scopes_cie"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the option "cie"
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, on scopes menu and hit ENTER key
            Gui Add, Picture, x198 y384 w324 h244, %A_ScriptDir%\images\step-by-step\pos_scopes_cie.png
        Case 25:
            _actualObject := "pos_scopes_display_focus"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the option "display focus"
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, on scopes three dots menu and hit ENTER key
            Gui Add, Picture, x198 y384 w324 h244, %A_ScriptDir%\images\step-by-step\pos_scopes_display_focus.png
        Case 26:
            _actualObject := "pos_scopes_low_pass_filter"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse over the option "low pass filter"
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, on scopes three dots menu and hit ENTER key
            Gui Add, Picture, x198 y384 w324 h244, %A_ScriptDir%\images\step-by-step\pos_scopes_low_pass_filter.png
        Case 27:
            _actualObject := "pos_custom_top_left"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse on top/left corner of the custom curves graphic
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, slightly before the top and left begins and hit ENTER key
            Gui Add, Picture, x5 y176 w710 h452, %A_ScriptDir%\images\step-by-step\pos_custom_top_left.png
        Case 28:
            _actualObject := "pos_custom_bottom_right"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse on top/left corner of the huevshue curves graphic
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, slightly before the top and left begins and hit ENTER key
            Gui Add, Picture, x5 y176 w710 h452, %A_ScriptDir%\images\step-by-step\pos_custom_bottom_right.png
        Case 29:
            _actualObject := "pos_hue_curves_top_left"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse on bottom/right corner of the custom curves graphic
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, slightly after the bottom and right ends and hit ENTER key
            Gui Add, Picture, x5 y360 w710 h267, %A_ScriptDir%\images\step-by-step\pos_hue_curves_top_left.png

        Case 30:
            _actualObject := "pos_hue_curves_bottom_right"
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Put your mouse on bottom/right corner of the huevshue curves graphic
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, slightly after the bottom and right ends and hit ENTER key
            Gui Add, Picture, x5 y360 w710 h267, %A_ScriptDir%\images\step-by-step\pos_hue_curves_bottom_right.png
        Default:
            _disableEnterKey := True
            
            NameResolutionAndScale()
            
            Gui Add, Text, x0 y0 w720 h50 +0x200 +Center, Wait! TWB is saving the positions on your INI file...
            Gui Add, Text, x0 y50 w720 h50 +0x200 +Center, When it's done, TWB will automaticaly close this window.
            
            setTimer, FinishTWB, 3000
    }

    Gui Show, w720 h640, TWB Set Position Window
...
_set_variable_button:
    ...
    if (buttonPressed == "Normal Layout"){
        _normalLayout := True
    }Else{
        _normalLayout := False
    }
