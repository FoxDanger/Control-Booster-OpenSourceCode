...
Gui Add, Button, g_set_variable_button vpos_hue_curves_cyan x960 y848 w150 h50, Cyan
Gui Add, Button, g_set_variable_button vpos_hue_curves_blue x1120 y848 w150 h50, Blue
Gui Add, Button, g_set_variable_button vpos_hue_curves_magenta x1280 y848 w150 h50, Magenta
Gui Add, Button, g_set_variable_button vpos_hue_curves_input_hue x1440 y720 w150 h50, Input Hue
Gui Add, Button, g_set_variable_button vpos_hue_curves_output x1440 y784 w150 h50, Output Hue Rotate/Sat/Lum
...
Gui Show, w1920 h1080, TWB 2.1.0
...
;Add or remove OSC2AHK Listeners - OSC2AHK Listerners (Latest Listener used: 0x1276)
Osc2ahkAddOrRemoveListeners(addOrRemove := "add"){
    if (addOrRemove == "add"){
        ...
        OnMessage(0x1043, "EnterEditMode")
       ...
       ;
        ;DllCall("OSC2AHK.dll\removeListener", AStr, "/_enterColorMode", UInt, 0x1101, UInt, oscTypeInt)
...
MoveMouseAndDrag(data, axis, objectName := "NULL"){
...
;Button - If some bug happens and the dots are not read correctly, you can press this button to read all the dots again
...
EnterEditMode(oscType, data, msgID, hwnd){
    if (data == 0)
    Return
...
ChangePage(page, from := "NONE"){
    Switch (page){
        Case "EDIT":
            ...
            ;Davinci Resolve Shortcut Shift+4 - Open Edit Page
            Send +4
...
SearchCustomCurvesDots(){
    ...
    ;MsgBox Top Left X: %topLeftX% - Top Left Y: %topLeftY% - Bottom Right X: %bottomRightX% - Bottom Right Y: %bottomRightY%
