...
Gui Show, w1920 h1080, TWB 2.1.4
...
Osc2ahkAddOrRemoveListeners(addOrRemove := "add"){
    if (addOrRemove == "add"){
        ...
        DllCall("OSC2AHK.dll\addListener", AStr, "/fastNavigateClips", UInt, 0x1513, UInt, oscTypeInt)
        OnMessage(0x1513, "_fastNavigateClips")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/deleteKey", UInt, 0x1514, UInt, oscTypeInt)
        OnMessage(0x1514, "_deleteKey")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/backspaceKey", UInt, 0x1515, UInt, oscTypeInt)
        OnMessage(0x1515, "_backspaceKey")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/colorInterfaceImageWipe", UInt, 0x1516, UInt, oscTypeInt)
        OnMessage(0x1516, "_colorInterfaceImageWipe")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/colorInterfaceSplitScreen", UInt, 0x1517, UInt, oscTypeInt)
        OnMessage(0x1517, "_colorInterfaceSplitScreen")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/colorInterfaceHighlight", UInt, 0x1518, UInt, oscTypeInt)
        OnMessage(0x1518, "_colorInterfaceHighlight")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/colorInterfaceZoomView", UInt, 0x1519, UInt, oscTypeInt)
        OnMessage(0x1519, "_colorInterfaceZoomView")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/colorInterfaceCursorHand", UInt, 0x1520, UInt, oscTypeInt)
        OnMessage(0x1520, "_colorInterfaceCursorHand")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/colorInterfaceNodeMode1", UInt, 0x1521, UInt, oscTypeInt)
        OnMessage(0x1521, "_colorInterfaceNodeMode1")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/colorInterfaceNodeMode2", UInt, 0x1522, UInt, oscTypeInt)
        OnMessage(0x1522, "_colorInterfaceNodeMode2")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/colorInterfaceNodeMode3", UInt, 0x1523, UInt, oscTypeInt)
        OnMessage(0x1523, "_colorInterfaceNodeMode3")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/colorInterfaceNodeMode4", UInt, 0x1524, UInt, oscTypeInt)
        OnMessage(0x1524, "_colorInterfaceNodeMode4")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/colorInterfaceGallery", UInt, 0x1525, UInt, oscTypeInt)
        OnMessage(0x1525, "_colorInterfaceGallery")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/colorInterfaceLuts", UInt, 0x1526, UInt, oscTypeInt)
        OnMessage(0x1526, "_colorInterfaceLuts")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/colorInterfaceMediaPool", UInt, 0x1527, UInt, oscTypeInt)
        OnMessage(0x1527, "_colorInterfaceMediaPool")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/colorInterfaceTimeline", UInt, 0x1528, UInt, oscTypeInt)
        OnMessage(0x1528, "_colorInterfaceTimeline")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/colorInterfaceClips", UInt, 0x1529, UInt, oscTypeInt)
        OnMessage(0x1529, "_colorInterfaceClips")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/colorInterfaceNodes", UInt, 0x1530, UInt, oscTypeInt)
        OnMessage(0x1530, "_colorInterfaceNodes")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/colorInterfaceOpenFX", UInt, 0x1531, UInt, oscTypeInt)
        OnMessage(0x1531, "_colorInterfaceOpenFX")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/colorInterfaceLightbox", UInt, 0x1532, UInt, oscTypeInt)
        OnMessage(0x1532, "_colorInterfaceLightbox")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/colorInterfaceImageWipeMode", UInt, 0x1533, UInt, oscTypeInt)
        OnMessage(0x1533, "_colorInterfaceImageWipeMode")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/projectSettings", UInt, 0x1534, UInt, oscTypeInt)
        OnMessage(0x1534, "_projectSettings")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/projectSelection", UInt, 0x1535, UInt, oscTypeInt)
        OnMessage(0x1535, "_projectSelection")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/davinciSettings", UInt, 0x1536, UInt, oscTypeInt)
        OnMessage(0x1536, "_davinciSettings")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/copy", UInt, 0x1537, UInt, oscTypeInt)
        OnMessage(0x1537, "_copy")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/paste", UInt, 0x1538, UInt, oscTypeInt)
        OnMessage(0x1538, "_paste")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/grabStill", UInt, 0x1539, UInt, oscTypeInt)
        OnMessage(0x1539, "_grabStill")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/applyGrade", UInt, 0x1540, UInt, oscTypeInt)
        OnMessage(0x1540, "_applyGrade")

        DllCall("OSC2AHK.dll\addListener", AStr, "/fullView", UInt, 0x1541, UInt, oscTypeInt)
        OnMessage(0x1541, "_fullView")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/stepFrame", UInt, 0x1542, UInt, oscTypeInt)
        OnMessage(0x1542, "_stepFrame")

        DllCall("OSC2AHK.dll\addListener", AStr, "/previousClip", UInt, 0x1543, UInt, oscTypeInt)
        OnMessage(0x1543, "_previousClip")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/nextClip", UInt, 0x1544, UInt, oscTypeInt)
        OnMessage(0x1544, "_nextClip")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/resetAllNodesGradeAndKeepNodes", UInt, 0x1545, UInt, oscTypeInt)
        OnMessage(0x1545, "_resetAllNodesGradeAndKeepNodes")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/resetNodeGrade", UInt, 0x1546, UInt, oscTypeInt)
        OnMessage(0x1546, "_resetNodeGrade")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/playBackward", UInt, 0x1547, UInt, oscTypeInt)
        OnMessage(0x1547, "_playBackward")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/stop", UInt, 0x1548, UInt, oscTypeInt)
        OnMessage(0x1548, "_stop")
    
        DllCall("OSC2AHK.dll\addListener", AStr, "/playForward", UInt, 0x1549, UInt, oscTypeInt)
        OnMessage(0x1549, "_playForward")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/startStop", UInt, 0x1550, UInt, oscTypeInt)
        OnMessage(0x1550, "_startStop")
        
        DllCall("OSC2AHK.dll\addListener", AStr, "/resetAllNodesGrade", UInt, 0x1551, UInt, oscTypeInt)
        OnMessage(0x1551, "_resetAllNodesGrade") ;Latest high
        ;Nodes and Scopes Listeners
        DllCall("OSC2AHK.dll\addListener", AStr, "/scopesLowPassFilter", UInt, 0x1398, UInt, oscTypeInt)
        OnMessage(0x1398, "_scopesLowPassFilter") ;Latest low
